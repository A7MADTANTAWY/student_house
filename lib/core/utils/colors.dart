...
// Light Theme Colors
const kLightBackgroundScaffoldColor = Color(0xFFFFFFFF); // أبيض للخلفية
const kLightPrimaryColor = Color(0xFF006EFF); // أزرق
...
const kDarkPrimaryColor = Color(0xFF006EFF); // أزرق أساسي
